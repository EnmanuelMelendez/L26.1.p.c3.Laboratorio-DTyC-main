...
export default class Cl_vLaboratorios {
    tbEquipos;
    btNuevoEquipo;
    vista;
    constructor() {
        this.vista = document.getElementById("laboratorios");
        this.tbEquipos = document.getElementById("Laboratorio_tbEquipos");
        this.btNuevoEquipo = document.getElementById("Laboratorio_btnNuevoEquipo");
    }
    onNuevoEquipo(callback) {

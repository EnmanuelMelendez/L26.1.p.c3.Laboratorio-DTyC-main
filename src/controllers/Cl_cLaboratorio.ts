...
import Cl_cEquipos from "./Cl_cEquipos.js";
import Cl_mEquipos from "../models/Cl_mEquipos.js";

export default class Cl_cLaboratorios {
    private mLaboratorios: Cl_mLaboratorios = new Cl_mLaboratorios();
    private vLaboratorios: I_vLaboratorios;
    private cEquipos: Cl_cEquipos;

    constructor(vistaLaboratorios: I_vLaboratorios, controladorEquipos: Cl_cEquipos) {
    ...
    private cargarDatosHardcodeados() {
    ...
    private reportarFalla(id: number) {
    ...
    private eliminarEquipo(id: number) {
        const equipo = this.mLaboratorios.obtenerEquipo(id);
    ...
    private actualizarVista() {
        ...
        this.vLaboratorios.mostrarEquipo({
            ...
            onReportarFalla: (id: number) => this.reportarFalla(id),
            onEliminarEquipo: (id: number) => this.eliminarEquipo(id)
        });
    }
}